...
public enum PortLocation
{
	...
	SEA_SPIRIT("Sea Spirit", new WorldPoint(3144, 2825, 0), new WorldPoint(3145, 2828, 0)),
	...
	BRIMHAVEN("Brimhaven", new WorldPoint(2758, 3230, 0), new WorldPoint(2768, 3225, 0)),
	CATHERBY("Catherby", new WorldPoint(2796, 3412, 0), new WorldPoint(2799, 3413, 0)),
